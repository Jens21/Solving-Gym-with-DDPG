...
def edit_observation(obs):
    ...
    ranges = th.Tensor([1.,  1.,  1.,  1.,  1., 10., 10., 10., 10.,  1.,  1.])
    obs /= ranges
...
def main():
    ...
    actor_policy, actor_target = Actor(input_size=11, action_size=1), Actor(input_size=11, action_size=1)
    actor_target.load_state_dict(actor_policy.state_dict())
    critic_policy, critic_target = Critic(input_size=11, action_size=1), Critic(input_size=11, action_size=1)
