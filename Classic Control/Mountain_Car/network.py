...
from sinesampler import SineSampler
...
class Network():
    ...
    def __init__(self, n_envs=1, load=False):
        self.n_envs = n_envs
        ...
        # self.sampler = OrnsteinUhlenbeckProcess(n_envs=n_envs, size=1, mu=0, theta=0.01, sigma=1)
        self.sampler = SineSampler(n_envs=n_envs, n_length=1, time_steps=200, n_waves=5)
    ...
    def get_action(self, obs):
        ...
        action += 0.7 * self.sampler.sample()
